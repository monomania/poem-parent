...
// The Downloader download page by package net/http.
...
func (this *Downloader) Download(req *request.Request) *page.Page {
	var mtype string
...
func (this *Downloader) acceptableCharset(contentTypes []string) bool {
...
func (this *Downloader) getCharset(header http.Header) string {
...
func (this *Downloader) changeCharsetEncoding(charset string, sor io.ReadCloser) string {
    ischange := true
...
func (this *Downloader) changeCharsetGoIconv(charset string, sor io.ReadCloser) string {
    var err error
...
func (this *Downloader) changeCharsetEncodingAuto(contentTypeStr string, sor io.ReadCloser) string {
	var err error
...
func (this *Downloader) changeCharsetEncodingAutoGzipSupport(contentTypeStr string, sor io.ReadCloser) string {
	var err error
...
func (this *Downloader) downloadFile(p *page.Page, req *request.Request) (*page.Page, string) {
	var err error
	var urlstr string
...
func (this *Downloader) downloadHtml(p *page.Page, req *request.Request) *page.Page {
	var err error
...
func (this *Downloader) downloadJson(p *page.Page, req *request.Request) *page.Page {
	var err error
	p, destbody := this.downloadFile(p, req)
	if !p.IsSucc() {
		return p
...
func (this *Downloader) downloadText(p *page.Page, req *request.Request) *page.Page {
	p, destbody := this.downloadFile(p, req)
	if !p.IsSucc() {
		return p
	}
