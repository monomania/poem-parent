...
// The PhraseDownloader download page by package net/http.
...
func NewPhraseDownloader() *PhraseDownloader {
	return &PhraseDownloader{}
}

func (this *PhraseDownloader) Download(req *request.Request) *page.Page {
	var mtype string
...
func (this *PhraseDownloader) acceptableCharset(contentTypes []string) bool {
...
func (this *PhraseDownloader) getCharset(header http.Header) string {
...
func (this *PhraseDownloader) changeCharsetEncoding(charset string, sor io.ReadCloser) string {
    ischange := true
...
func (this *PhraseDownloader) changeCharsetGoIconv(charset string, sor io.ReadCloser) string {
    var err error
...
func (this *PhraseDownloader) changeCharsetEncodingAuto(contentTypeStr string, sor io.ReadCloser) string {
	var err error
...
func (this *PhraseDownloader) changeCharsetEncodingAutoGzipSupport(contentTypeStr string, sor io.ReadCloser) string {
	var err error
...
func (this *PhraseDownloader) downloadFile(p *page.Page, req *request.Request) (*page.Page, string) {
	var err error
	var urlstr string
...
func (this *PhraseDownloader) downloadHtml(p *page.Page, req *request.Request) *page.Page {
	var err error
...
func (this *PhraseDownloader) downloadJson(p *page.Page, req *request.Request) *page.Page {
	var err error
	p, destbody := this.downloadFile(p, req)
	if !p.IsSucc() {
		return p
...
func (this *PhraseDownloader) downloadText(p *page.Page, req *request.Request) *page.Page {
	p, destbody := this.downloadFile(p, req)
	if !p.IsSucc() {
		return p
	}
